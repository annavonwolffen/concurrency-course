...
public class RestaurantServiceAtomicLong extends RestaurantService {

    private final ConcurrentHashMap<String, AtomicLong> stat = new ConcurrentHashMap<>();
    ...
    public void addToStat(String restaurantName) {
        ...
        stat.computeIfAbsent(restaurantName, rn -> new AtomicLong()).getAndIncrement();
    }
